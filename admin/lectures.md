...
{{ module }}T lectures are same as that for {{ module }}. Please ignore the CS2101 session scheduled at the same slot. That is a dummy slot used to work around a limitation of the Edurec modreg system. 
